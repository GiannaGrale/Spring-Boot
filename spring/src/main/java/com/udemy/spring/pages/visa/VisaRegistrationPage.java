package com.udemy.spring.pages.visa;
...
public class VisaRegistrationPage extends Base {
    ...
    public void setNames(String firstName, String lastName) {
        logger.info(String.format("Getting names: %s %s ", firstName, lastName));
    ...
    public void setBirthDate(LocalDate birthDate) {
        new Select(this.year).selectByValue(String.valueOf(birthDate.getYear()));
        new Select(this.day).selectByValue(String.valueOf(birthDate.getDayOfMonth()));
        new Select(this.month).selectByValue(birthDate.getMonth().toString());
    }
